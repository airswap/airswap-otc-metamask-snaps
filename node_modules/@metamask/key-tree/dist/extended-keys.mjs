...
import { validateBIP44Depth } from "./BIP44Node.mjs";
import { compressPublicKey, decompressPublicKey } from "./curves/secp256k1.mjs";
import { decodeBase58check, encodeBase58check, isValidBytesKey } from "./utils.mjs";
 ...
 */
export const decodeExtendedKey = (extendedKey) => {
 ...
 */
export const encodeExtendedKey = (extendedKey) => {
...
//# sourceMappingURL=extended-keys.mjs.map