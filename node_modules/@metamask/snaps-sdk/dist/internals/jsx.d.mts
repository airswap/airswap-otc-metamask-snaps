 ...
 * one of the structs.
 */
export declare function nullUnion<Head extends AnyStruct, Tail extends AnyStruct[]>(structs: [head: Head, ...tail: Tail]): Struct<Infer<Head> | InferStructTuple<Tail>[number], null>;
export {};
//# sourceMappingURL=jsx.d.mts.map