import { stringToBytes, bytesToHex, hexToBigInt, remove0x, assert } from "@metamask/utils";
 ...
 */
export const bytesToNumberLE = (bytes) => {
 ...
 */
export const multiplyWithBase = (key) => {
...
//# sourceMappingURL=ed25519Bip32.mjs.map