...
import { CaipAccountAddressStruct, CaipAccountIdStruct, CaipChainIdStruct, hasProperty, HexChecksumAddressStruct, isPlainObject, JsonStruct } from "@metamask/utils";
 ...
 */
export const InputStruct = element('Input', {
    name: string(),
